...
import br.com.dennon.integrationtests.vo.PersonVO;
import br.com.dennon.integrationtests.vo.pagedmodels.PagedModelPerson;
				...
				.config(
						RestAssuredConfig
							...
							.encoderConfig(EncoderConfig.encoderConfig()
									.encodeContentTypeAs(
											TestConfigs.CONTENT_TYPE_YML, 
											ContentType.TEXT))).spec(specification)
				.contentType(TestConfigs.CONTENT_TYPE_YML)
				.accept(TestConfigs.CONTENT_TYPE_YML)
